            ...
            <div className='reviews-grid' style={{ pointerEvents: 'none' }}>
                {Array.from({ length: 3 }).map((_, index) => (
                    <article key={index} className='review-card'>
                        ...
                        <div className='review-card-content' style={{ width: '100%', margin: '0 auto' }}>
                            ...
                            <div className='review-card-date-rating skeleton-mobile-row' style={{ width: '100%', margin: '0 auto' }}>
