...
function Home() {
	...
	if (hasError)
		return <ErrorMessage message={hasError.message} onRetry={handleRetry} />;

	if (isEmpty)
		return <EmptyState actionText="Recarregar" onAction={handleRetry} />;
	...
	return (
		<div>
			...
			<MovieSection title={'Populares'} movies={popular} loading={isLoading} />
